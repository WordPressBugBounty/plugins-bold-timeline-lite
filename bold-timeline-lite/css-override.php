...
$css_override = '';
if ( $defaultLineColor != '' ) { $css_override .= sanitize_text_field(":root{--boldthemes-default-line-color: {$defaultLineColor};}" ); }
...
if ( $defaultIconColor != '' ) { $css_override .= sanitize_text_field(":root{--boldthemes-default-item-background-color: {$defaultItemBackgroundColor};
...
if ( $defaultButtonColor != '' ) { $css_override .= sanitize_text_field(".bold_timeline_container .bold_timeline_item .bold_timeline_item_button{--default-button-color: {$defaultButtonColor};}" ); }
